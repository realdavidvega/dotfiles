# Generated by Powerlevel10k configuration wizard on 2022-05-24 at 09:44 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='?'     # Standard git untracked

  # Added standard short-status style icons:
  typeset -g POWERLEVEL9K_VCS_UNSTAGED_ICON='M'      # Modified (git status short)
  typeset -g POWERLEVEL9K_VCS_STAGED_ICON='+'        # Staged
  typeset -g POWERLEVEL9K_VCS_COMMITS_AHEAD_ICON='↑' # Ahead
  typeset -g POWERLEVEL9K_VCS_COMMITS_BEHIND_ICON='↓' # Behind
